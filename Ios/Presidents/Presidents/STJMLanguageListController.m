...
@interface STJMLanguageListController ()

@end

@implementation STJMLanguageListController
...
- (void)viewDidLoad
{
    ...
    self.languageCodes = @[@"en",@"fr"];
    self.clearsSelectionOnViewWillAppear = NO;
    self.contentSizeForViewInPopover = CGSizeMake(320.0, [self.languageCodes count]*44);
